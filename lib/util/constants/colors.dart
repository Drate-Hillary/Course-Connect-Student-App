...
class AppColors {
  // App theme colors
  static const Color primaryColor = Color(0xff0307fc);
  static const Color secondaryColor = Color(0xFFFFE24B);
  static const Color accentColor = Color(0xFFb0c7ff);

  // Icon colors
  static const Color iconColor = Color(0xFF8D8D8D);
  ...
  static Color darkContainer = AppColors.whiteColor.withAlpha(alpha);

  // Button colors
  static const Color buttonPrimary = Color(0xff07037c);
