class TextStrings {
  // app title
  static const String appTitle = "Course Connect"; 
  ...
  static const String onBoardingSubTitle3 = "Stay updated with real-time notifications and announcements";
  ...
  static const String repeatPassword = "Repeat your password";
  ...
  static const String signUp = "Let's create your account";
  static const String signUpSubTitle = "Gain full visibility into your restaurant's operations. Sign up to configure table layouts, manage staff assignments, and oversee real-time kitchen performance.";
  ...
  static const String  sentVerificationCode = "Sent Verification Code";
  static const String verificationCode = "Verification Code";
  static const String verificationCodeSubTitle = "Enter the 6-digit code sent to your email address.";

  // Authentication Reading Texts
  static const String loginTitle = "Welcome Back";
  static const String loginSubTitle ="Enter your email and password to login.";
