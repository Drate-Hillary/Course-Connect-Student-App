...
class DeviceUtility {
  ...
  static bool isDesktopScreen(BuildContext context) {
    return MediaQuery.of(context).size.width >= AppSize.desktopScreenSize;
  }

  static bool isTabletScreen(BuildContext context) {
    return MediaQuery.of(context).size.width >= AppSize.tabletScreenSize && MediaQuery.of(context).size.width < AppSize.desktopScreenSize;
  }
